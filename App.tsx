...
import NewPortfolioVideoModal from './components/modals/NewPortfolioVideoModal';

interface ModalState {
    type: 'hub' | 'newClient' | 'newProject' | 'newTask' | 'newVideo' | 'newEvent' | 'newPortfolioVideo';
    payload?: any;
}
...
const AuthenticatedApp: React.FC = () => {
    ...
    const handleNewItem = () => {
        switch(view) {
            ...
            case 'portfolio': openModal('newPortfolioVideo'); break;
    ...
    const renderView = () => {
        switch (view) {
            ...
            case 'portfolio':
                return <Portfolio openModal={openModal} />;
            case 'notes':
                return <Notes />;
            case 'settings':
                return <Settings />;
    ...
    const renderModals = () => {
        ...
        switch(activeModal.type) {
            ...
            case 'newPortfolioVideo':
                return <NewPortfolioVideoModal onClose={closeModal} onVideoCreated={closeModal} payload={activeModal.payload} />;
            case 'newEvent':
    ...
    const mainContentClass = view === 'calendar' || view === 'projects' || view === 'notes' || view === 'portfolio'
